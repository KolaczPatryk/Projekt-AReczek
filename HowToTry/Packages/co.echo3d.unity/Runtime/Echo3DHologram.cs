...
public class Echo3DHologram : MonoBehaviour
{
    ...
    private string secKey = "XmPpMMWDmJhVa4tDhaMv6k6G";
    // Your echo3D API key
    ...
    private const string API_KEY_PLACEHOLDER = "sparkling-credit-2416";
    private const string SEC_KEY_PLACEHOLDER = "XmPpMMWDmJhVa4tDhaMv6k6G";
